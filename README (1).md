...
## 9. Acknowledgements & Tools Used

- **Dataset:** [Medical Appointment No Shows](https://www.kaggle.com/datasets/joniarroba/noshowappointments) (Kaggle, public domain).
- **Libraries:** pandas, numpy, scikit-learn, matplotlib, seaborn, joblib (see `requirements.txt`).
- **AI assistance:** Claude (Anthropic) was used as a learning assistant throughout this project — for step-by-step guidance, explaining ML/statistics concepts, drafting boilerplate code, debugging errors, and structuring documentation. All code was written into the notebook, run, reviewed, and understood by the author, who can explain and defend every step of the pipeline. No AI service was presented as a model trained or fine-tuned by the author; the trained model in this repository (`noshow_model.joblib`) was fit locally on the dataset using scikit-learn.
